...
export default {
  ...
  methods: {
    clickMe:function(){
      ...
      }else if(this.sendType=='HomeOutImg'){
        this.$parent.jumpTo();
      }else if(this.sendType==='hotSellGoods'){
        this.$parent.jumpTo();        
      }
    },
    ...
    deleteImg:function(){
      var that = this;
      if(that.sendType=='HomeOutImg'){
          that.$parent.deleteHomeImg(that._id) 
      }else if(that.sendType=='hotSellGoods'){
          that.$parent.deleteHomeImg(that._id)         
      }else{
